...
const RulesComponent = () => (
  <div className="rules-content">
    ...
    <div className="rules-list">
      <div className="rules-list-element">
        ...
        <span className="element">
          Nie śmiecimy, nie hałasujemy, nie niszczymy przyrody, pomagamy sobie nawzajem. To
          oczywiste
        </span>
      </div>
      <div className="rules-list-element">
        ...
        <span className="element">
          ...
          przy ognisku. Sam lubię oba.
        </span>
      </div>
      <div className="rules-list-element">
        <Eco />
        <span className="element">Bądźmy sobie po prostu przyjaźni :)</span>
      </div>
    </div>
    ...
    <div className="rules-list">
      ...
      <div className="rules-list-element">
        <Forward />
        <span className="element">Odcinek można przejść wariantem głównym lub alternatywnym</span>
      </div>
      <div className="rules-list-element">
        <Forward />
        <span className="element">
          Odcinki można przechodzić etapami, nie trzeba wszystkiego na raz
        </span>
      </div>
      <div className="rules-list-element">
        <Forward />
        <span className="element">
          Jeśli już kiedyś przeszedłeś dany odcinek, nie musisz go powtarzać. Możesz, jeśli chcesz
          :)
        </span>
      </div>
      <div className="rules-list-element">
        <Forward />
        <span className="element">
          Trasę można przejść w obie strony. Aczkolwiek oficjalnym początkiem jest Bardo
        </span>
      </div>
      <div className="rules-list-element">
        <Forward />
        <span className="element">
          Pozwalamy na własne <Link to="/own_route">modyfikacje trasy</Link>
        </span>
      </div>
    </div>
    ...
    <div className="rules-list">
      ...
      <div className="rules-list-element">
        <EmojiEvents />
        <span className="element">Trasę należy przejść głównym wariantem GSS 2.0</span>
      </div>
      <div className="rules-list-element">
        <EmojiEvents />
        <span className="element">
      ...
      <div className="rules-list-element">
        <EmojiEvents />
        <span className="element">
          Rekord jest niezależny od kierunku, ale będą też klasyfikacje oddzielne
        </span>
      </div>
    </div>
    ...
    <div className="rules-list">
      <div className="rules-list-element">
        ...
        <span className="element">
          ...
          zweryfikować, jednak wystarczy nam cokolwiek - relacje, zdjęcia, pliki z trasą ,filmy.
        </span>
      </div>
      <div className="rules-list-element">
        <ThumbUp />
        <span className="element">
          ...
          przebiegiem aktywności lub inny dowód jak dla finisherów, ale koniecznie zawierający
          godzinę startu i mety.
        </span>
      </div>
    </div>
  </div>
